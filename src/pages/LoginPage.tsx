  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        opacity: 0.12, top: '20%', left: '25%', filter: 'blur(40px)',
      ...
      <div className="glass-panel login-card" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.75rem' }}>
            ...
            <span style={{ fontFamily: 'var(--font-heading)', fontSize: '1.4rem', fontWeight: 800, letterSpacing: '-0.03em' }}>AIVORA</span>
          </div>
        ...
        {displayError && (
          <div className="badge badge-danger" style={{
            ...
            alignItems: 'flex-start', gap: '0.5rem', marginBottom: '1.5rem', fontWeight: 500,
          }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input id="email-input" type="email" placeholder="you@domain.com"
